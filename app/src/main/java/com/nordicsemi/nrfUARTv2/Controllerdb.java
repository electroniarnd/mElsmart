...
public class Controllerdb extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String query;
        query = "CREATE TABLE IF NOT EXISTS tblLogs(Id INTEGER PRIMARY KEY AUTOINCREMENT,date TEXT,time TEXT,BadgeNo VARCHAR,Name VARCHAR,Ter VARCHAR,empid INTEGER,direction INTEGER DEFAULT  0,GeoID INTEGER DEFAULT  0,QRId INTEGER DEFAULT  0,PunchType TEXT,sent INTEGER DEFAULT  0);";
        db.execSQL(query);
