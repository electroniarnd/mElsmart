...
public class CircularProgressButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            int green = getColor(R.color.cpb_green);
            int orange=getColor(R.color.cpb_orange);
            ...
            //进度条的颜色
            mColorProgress = attr.getColor(R.styleable.CircularProgressButton_cpb_colorProgress, green);
    ...
    public void setProgressColor(int cc)
    {
        mColorProgress=cc;
    }
