...
public class Controllerdb extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("Create table  IF NOT EXISTS Registration(ID INTEGER PRIMARY KEY AUTOINCREMENT,Employee_Id INTEGER DEFAULT 0,UserRole INTEGER DEFAULT 0,QRCode INTEGER DEFAULT 0,Geofence INTEGER DEFAULT 0,Tracking INTEGER DEFAULT 0,Tracking_Type_Id INTEGER DEFAULT 0,BLE INTEGER DEFAULT 0,FullName TEXT,IMEI TEXT,ModelNo TEXT,ValidFromDate TEXT,IssuedDate TEXT,ExpiryDate TEXT ,Title TEXT ,DeptName TEXT,BadgeNo TEXT,Company_Id INTEGER DEFAULT 0,Interval INTEGER DEFAULT 0,MinDist INTEGER DEFAULT 0,Cust_Id INTEGER DEFAULT 0,Customer_Virtual_Id INTEGER DEFAULT 0,url TEXT,GeoQR INTEGER DEFAULT 0,SysType TEXT)");
